...
export const allLanguage = () => {
    const get_language = getLanguages.dictionary;
    const lang_code = Object.keys(get_language);
    let languages =[];
    lang_code.forEach((key) => {
        var lang = get_language[key];
        // languages.value.push(lang.nativeName)
        languages.push({
            code: key,
            name: lang.name,
